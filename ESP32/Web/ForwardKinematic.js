...
function calculateForwardKinematics() {
    ...
    let theta1_FK, theta2_FK, theta3_FK, theta_FK;
    let theta1_FK_rad, theta2_FK_rad, theta3_FK_rad, theta4_FK_rad;
    let Px_FK, Py_FK, Pz_FK, theta4_FK;
    ...
    Px_FK = Math.cos(theta1_FK_rad) * (L1 + L2 * Math.cos(theta2_FK_rad) + L3 * Math.cos(theta2_FK_rad + theta3_FK_rad) + L4 * Math.cos(theta4_FK_rad));
    Px_FK = Math.round(Px_FK * 10) / 10;

    Py_FK = Math.sin(theta1_FK_rad) * (L1 + L2 * Math.cos(theta2_FK_rad) + L3 * Math.cos(theta2_FK_rad + theta3_FK_rad) + L4 * Math.cos(theta4_FK_rad));
    Py_FK = Math.round(Py_FK * 10) / 10;

    Pz_FK = d1 + L3 * Math.sin(theta2_FK_rad + theta3_FK_rad) + L2 * Math.sin(theta2_FK_rad) + L4 * Math.sin(theta4_FK_rad);
